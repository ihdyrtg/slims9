...
<div class="container">
    <div class="flex flex-wrap">
        <div class="w-64 mb-2 hidden">
            <div class="bg-grey-light p-12 rounded">
                <div class="shadow" ref="bookCover">
                  <?= $image; ?>
                </div>
            </div>
        </div>
        <div class="flex-1 p-0 px-md-4">
          ...
          <?php }; ?>
            ...
            <div itemprop="associatedMedia">
              <?php echo str_replace('class="openPopUp"', 'class="openPopUp" v-on:click="openPDFPopUp($event)"', $file_att); ?>
            </div>
