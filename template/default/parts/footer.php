...
<footer class="py-2 bg-secondary text-grey-lighter">
    <div class="container">
        <div class="row py-2">
            <div class="col-md-3">
                <!--
				...
				-->
                <img class="s-logo animated flipInY delay7" src="template/default/assets/images/logo_iain.png" width="150" height="150">
                <div class="mb-4">
                    Perpustakaan IAIN<br>
                    Padangsidimpuan </div>
                ...
                <a target="_blank" title="Perpanjang Masa Peminjaman Online" class="btn btn-outline-success mb-2" href="http://library.fis.uny.ac.id/sp/subjects/index.php"><i class="fas fa-question mr-2"></i>Subject Guide (Topic Corner)</a>
                <a title="Perpanjang Masa Peminjaman Online" class="btn btn-outline-success mb-2" href="index.php?p=member"><i class="fas fa-file-pdf mr-2"></i>Cek Plagiarisme Tulisan</a>
