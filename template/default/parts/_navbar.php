...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
  <a class="navbar-brand inline-flex items-center" href="index.php">
    ...
    if (isset($sysconf['logo_image']) && $sysconf['logo_image'] != '' && file_exists('images/default/' . $sysconf['logo_image'])) {
      ...
      echo '<img class="h-8 w-8" src="' . assets('images/logo-big.png') . '">';
    } else {
    ?>
      <!-- <svg
      ...
      <?php } else { ?>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu bg-blue-lighter dropdown-menu-lg-right" aria-labelledby="dropdownbutton">
            ...
            <a class="dropdown-item" href="http://ebooks.iain-padangsidimpuan.ac.id/index.php">Galeri Buku Digital</a>
            <a class="dropdown-item" href="http://jurnal.iain-padangsidimpuan.ac.id/">Rumah Jurnal</a>
            <a class="dropdown-item" href="http://repo.iain-padangsidimpuan.ac.id/">Resource Repository</a>
            <a class="dropdown-item" href="http://etd.iain-padangsidimpuan.ac.id/">E-Thesis</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
