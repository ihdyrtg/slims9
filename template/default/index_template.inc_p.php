...
/*----------------------------------------------------
  ...
  $menus = array (
	...
	'perpanjang'   => array('url'  => 'index.php?p=perpanjang',
      'text' => __('Perpanjang')
      ),
 ...
 <div class="container">
  <div class="row">
    <div class="span12 lisence">
     This software and this template are released Under GNU GPL License Version 3 - The Winner in the Category of OSS Indonesia ICT Award 2009 - SLiMS FullPlugin By : <a href="http://slimskudus.blogspot.com" target="blank">SLiMS Kudus</a>
   </div>
 </div>
</div>
</div>
...
jQuery(function($){
  $.supersized(
  {
    ...
    {image : '<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/6.jpg'},
    ...
    {image : '<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/5.jpg'},
