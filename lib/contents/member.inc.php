...
if ($is_member_login) :
    ...
    /* Experimental Loan Extend - start */
    function showLoanExtend($num_recs_show = 20)
    {
        $_form = '<form id="perpanjangan_mandiri" method="post" action="index.php?p=member&sec=perpanjangan_mandiri">' . "\n";
        $_form .= '<span class="value alterCell2"><input type="text" name="item" class="form-control" placeholder="Enter item kode" /></span>' . '<br>';
        $_form .= '<input class="btn btn-primary" type="submit" id="loginButton" name="doPerpanjang" value="' . __('Proses') . '" />';
        $_form .= '</form>' . "\n";
        return $_form;
    }
            ...
            <div class="my-5">
                <ul class="nav nav-tabs nav-fill">
                    ...
                    $tabs_menus = [
                        ...
                        'perpanjangan_mandiri' => [
                            'text' => __('Perpanjangan Mandiri'),
                            'link' => 'index.php?p=member&sec=perpanjangan_mandiri'
                        ],
                        'my_account' => [
                            'text' => __('My Account'),
                ...
                <div class="bg-white border-right border-bottom border-left p-4">
                    ...
                    switch ($section) {
                        ...
                        case 'loan_history':
                            ...
                            echo showLoanHist();
                            break;
                        case 'perpanjangan_mandiri':
                            echo '<div class="tagline">';
                            echo '<div class="memberInfoHead">' . __('Perpanjangan Peminjaman Mandiri') . '</div>' . "\n";
                            echo '</div>';
                            echo showLoanExtend();
                            break;
                        case 'my_account':
...
<?php else: ?>
    <div>
        ...
        <div class="loginInfo">
            <form action="index.php?p=member<?= urlencode($_GET['destination']) ?>" method="post">
