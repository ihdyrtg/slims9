...
if (isset($_POST['detail']) or (isset($_GET['action']) and $_GET['action'] == 'detail')) {
  ...
  if (isset($rec_d['member_image']) && file_exists(IMGBS . '/persons/' . $rec_d['member_image'])) {
    $str_input .= '<a href="' . SWB . 'images/persons/' . $rec_d['member_image'] . '" class="openPopUp notAJAX" title="' . __('Click to enlarge preview') . '" width="1000" height="500">';
...
<?php
  ...
  function showMemberImage($obj_db, $array_data)
  {
    ...
    $_output = '<div class="media"> 
                    <a href="' . $image . '" class="openPopUp notAJAX" title="' . $_d[1] . '" width="800" height="500" >
